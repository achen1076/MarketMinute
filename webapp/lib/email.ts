...
export function getEmailVerificationHTML(verifyUrl: string, userEmail: string) {
  return `
<!DOCTYPE html>
<html>
<head>
              ...
              <table role="presentation" style="width: 100%; border-collapse: collapse;">
                <tr>
                  <td align="center" style="padding: 0 0 30px;">
                    <a href="${verifyUrl}" style="display: inline-block; padding: 14px 32px; background-color: #14b8a6; color: #ffffff; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: 600;">
