      ...
      <div className="mb-4 p-3 rounded-lg bg-muted/40">
        ...
        <div className="flex items-center justify-between text-sm">
          <div className="text-center flex-1">
            ...
            <p className="text-xs text-muted-foreground mt-1">10th</p>
          </div>
          <div className="text-center flex-1 border-x border-border mx-2 px-2">
            <p className="text-foreground font-bold">${p50.toFixed(2)}</p>
            <p className="text-xs text-muted-foreground mt-1">Median</p>
          </div>
          <div className="text-center flex-1">
            <p className="text-emerald-400 font-semibold">${p90.toFixed(2)}</p>
            <p className="text-xs text-muted-foreground mt-1">90th</p>
          </div>
        </div>
      </div>
