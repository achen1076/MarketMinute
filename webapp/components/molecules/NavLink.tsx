...
const NavLink = ({
  ...
  const underlineClasses = cn(
    "relative inline-block after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-[#9739bf] after:transition-all after:duration-300 after:ease-in-out hover:after:w-full",
