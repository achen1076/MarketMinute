...
echo "============================================"
echo ""
echo "Image URI (tag):    ${ECR_URI}:${IMAGE_TAG}"
echo "Image URI (digest): ${ECR_URI}@${PUSHED_DIGEST}"
echo ""
echo -e "${YELLOW}👉 To update SageMaker endpoint with new image:${NC}"
echo ""
echo "   cd ../../infrastructure/terraform"
echo "   terraform apply -var=\"sagemaker_image_uri=${ECR_URI}@${PUSHED_DIGEST}\""
echo ""
echo -e "${BLUE}💡 Using digest ensures SageMaker recreates the model with new code${NC}"
echo ""
